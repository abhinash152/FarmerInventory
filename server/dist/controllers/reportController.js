...
exports.getFarmerAnalytics = exports.getFarmerDashboardStats = void 0;
...
const getFarmerDashboardStats = async (req, res) => {
    try {
        ...
        const [pendingOrders, acceptedOrders, rejectedOrders] = await Promise.all([
            prisma_1.prisma.order.count({ where: { farmer_id: farmerId, status: prisma_1.OrderStatus.PENDING } }),
            prisma_1.prisma.order.count({ where: { farmer_id: farmerId, status: prisma_1.OrderStatus.ACCEPTED } }),
            prisma_1.prisma.order.count({ where: { farmer_id: farmerId, status: prisma_1.OrderStatus.REJECTED } }),
        ]);
...
exports.getFarmerDashboardStats = getFarmerDashboardStats;
...
exports.getFarmerAnalytics = getFarmerAnalytics;
